...
export default function SubscriptionCard({
    ...
    return (
        <>
            {/* Basic */}
            {!isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content] hover:shadow-md transition-all fade-in-out duration-300">
            ...
            {/* For Greatest */}
            {isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 rounded-[26px] text-white w-[300px] bg-black hover:shadow-md hover:shadow-alerange transition-all fade-in-out duration-300">
                    {/* Ornament Icon */}
